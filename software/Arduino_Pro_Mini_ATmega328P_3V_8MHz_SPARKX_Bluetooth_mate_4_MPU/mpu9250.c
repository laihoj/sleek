...
//slave address: 0b1101000 (if pin AD0 is logic low)or 0b1101001 (if AD0 is logic high)
//accelerometer register address: 0x3B
...
determined by the logic level on pin AD0. This allows two MPU-9250s to be connected to the same I2
C bus.
...
#define SENSOR_I2CADD 0b1101000 //Address for the sensor. Different for each device connected.
